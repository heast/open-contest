...
from contest.UIElements.lib.htmllib import UIElement, div, h1, a, h, h2, head, body
...
class Footer(UIElement):
    def __init__(self):
        self.html = div(cls="footer", contents=[
            h2(
                'Copyright &copy; {} by <a href="https://nathantheinventor.com" target="_blank">Nathan Collins</a>'.format(
                    datetime.now().year)),
            ...
            div(cls="modal-dialog", role="document", contents=[
                div(cls="modal-content", contents=[
                    div(cls="modal-header", contents=[
                        ...
                        h.button(
                            **{"type": "button", "class": "close", "data-dismiss": "modal", "arial-label": "close"},
                            contents=[
